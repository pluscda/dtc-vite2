<template>
  <div class="pr-1 -mt-2">
    ...
    <footer class="mt-5 mb-10">
      <Button class="p-button-rounded p-button-info" style="margin: 4px 0" @click="createItem">建立初診資料</Button>
...
const selfFillForm = { weightGain: {}, weightGainOptions1: {}, weightGainOptions2: {} };
let basicCard = {
  hisId,
  sex,
  carrer,
...
export default {
  ...
  methods: {
    async createItem() {
      ...
      await this.actions.addBasicInfo({ ...this.basicCard, selfFillForm: _selfFillForm });
    },
  },
};
</script>
