<template>
  <nav class="text-blue-200 bg-gradient-to-r from-blue-900 to-blue-700 dtc-nav-bar">
    <span :class="bgColor ? 'text-fuchsia-300' : ''"><i-uim:layer-group class="pt-2 text-5xl"></i-uim:layer-group></span>
    ...
    <section class="flex gap-8 cursor-pointer">
      ...
      <el-dropdown class="max-h-10" :show-timeout="1">
        ...
        <el-dropdown-menu>
          <el-dropdown-item @click="$router.push('/pharmacy/drugmanagement')">藥品信息維護</el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
      <el-dropdown class="max-h-10" :show-timeout="1">
    ...
    <div class="grid grid-cols-2 cursor-pointer relative" @click="toggleBg">
      ...
      <div class="mt-2.5 relative">
        <el-tooltip content="切換暗色系主題顏色" placement="bottom" effect="light">
